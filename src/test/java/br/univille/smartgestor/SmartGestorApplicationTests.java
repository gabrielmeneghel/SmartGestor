package br.univille.smartgestor;
...
import br.univille.smartgestor.controller.HomeController;
import br.univille.smartgestor.controller.PacienteController;

@RunWith(SpringRunner.class)
@SpringBootTest
@AutoConfigureMockMvc
public class SmartGestorApplicationTests {
	...
	.andExpect(content().string(containsString("Aeeeee")));
	}
